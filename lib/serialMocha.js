...
SerialMocha.prototype.runTasks = function(theTasks, theReporter, saveData, theReporterDirectory) {
  ...
  if (typeof theTasks === 'string') theTasks = _this.getTestFiles(theTasks);
  ...
  return new Promise(function (resolve, reject) {
    ...
    var defaultReporter = __dirname + path.sep + 'serialReporter';
    ...
    spr.runTasks()
      ...
      .then(function (res) {
        ...
        if (res) {
          ...
          _this.__emit('run-ended', {timestamp:now, duration:duration, results:aggregatedResults, metrics:runMetrics});
